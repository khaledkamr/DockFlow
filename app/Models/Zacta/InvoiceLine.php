...
class InvoiceLine
{
    ...
    public $invoiceLineXMLString = '<cac:InvoiceLine>
        ...
        <cac:TaxTotal>
             <cbc:TaxAmount currencyID="SAR">LINEVATAMOUNT</cbc:TaxAmount>
        ...
        <cac:Item>
            ...
            <cac:ClassifiedTaxCategory>
                <cbc:ID>S</cbc:ID>
                <cbc:Percent>LINEVAT</cbc:Percent>
                <cac:TaxScheme>
                    <cbc:ID>VAT</cbc:ID>
                </cac:TaxScheme>
            </cac:ClassifiedTaxCategory>
        ...
        <cac:Price>
            ...
            <cbc:BaseQuantity unitCode="LINEUOM">1</cbc:BaseQuantity>
            <cac:AllowanceCharge>
