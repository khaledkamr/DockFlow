    ...
    public function collection()
    {
        ...
        return $query->get()->map(function ($transportOrder) {
            ...
            return [
                ...
                $transportOrder->commission,
                $transportOrder->diesel_cost,
                $transportOrder->driver_wage,
                $transportOrder->clearance_fee,
                $transportOrder->late_fee,
                $transportOrder->client_cost,
                $transportOrder->total_cost,
                $transportOrder->total_cost - $transportOrder->supplier_cost - $transportOrder->commission,
            ];
        });
    }
