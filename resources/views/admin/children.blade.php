        ...
        <li class="relative m-0 p-0">
            <div class="account-node {{ $child->children->count() ? 'has-children' : '' }} bg-level-{{$child->level}}" 
                ...
                <div class="account-info">
                    ...
                    <div>
                        @if($child->level < 5)
                            <button class="badge bg-danger text-white fs-6 rounded-1 border-0 ">-</button>
                            <button class="badge bg-dark text-white fs-6 rounded-1 border-0"
                                type="button" data-bs-toggle="modal" data-bs-target="#addRoot{{ $child->id }}">+</button>
                        @endif
                    </div>
                </div>
            </div>
