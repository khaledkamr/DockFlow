...
@section('content')
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header d-flex flex-row justify-content-between align-items-start align-items-sm-center gap-2 bg-dark text-white">
    ...
    <div class="modal fade" id="editDurationModal" tabindex="-1" aria-labelledby="editDurationModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('contracts.update', $contract) }}" method="POST">
                    ...
                    <div class="modal-body text-dark">
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="date" class="form-control border-primary" name="start_date"
                                    value="{{ $contract->start_date }}" required>
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">تاريخ الإنتهاء</label>
                                <input type="date" class="form-control border-primary" name="end_date"
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" min="1" step="1"
                                        class="form-control border-primary" name="payment_grace_period"
                                        value="{{ $contract->payment_grace_period }}" required>
                                    <select name="payment_grace_period_unit" class="form-select border-primary"
                                        style="max-width: 140px;" required>
                                        <option value="يوم"
                                            {{ $contract->payment_grace_period_unit == 'يوم' ? 'selected' : '' }}>
                                            يوم</option>
                                        <option value="أيام"
                                            {{ $contract->payment_grace_period_unit == 'ايام' ? 'selected' : '' }}>
                                            أيام</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer d-flex flex-column flex-sm-row justify-content-start gap-2">
                        <button type="submit" class="btn btn-primary fw-bold order-1 order-sm-1">حفظ
                            التعديلات</button>
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div
                    class="card-header d-flex flex-row justify-content-between align-items-start align-items-sm-center gap-2 bg-dark text-white">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-building me-2"></i>
                        الطرف الأول
                    </h5>
                    <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                        data-bs-target="#editRepresentativeOneModal">
                        تعديل الممثل
                    </button>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div
                    ...
                    <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                        data-bs-target="#editRepresentativeTwoModal">
                        تعديل الممثل
                    </button>
                </div>
                <div class="card-body">
    ...
    <div class="modal fade" id="editRepresentativeOneModal" tabindex="-1"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control border-primary"
                                    name="company_representative" value="{{ $contract->company_representative }}"
                                    required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">الجنسية</label>
                                <input type="text" class="form-control border-primary"
                                    name="company_representative_nationality"
                                    value="{{ $contract->company_representative_nationality }}" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">الرقم القومي</label>
                                <input type="text" class="form-control border-primary"
                                    name="company_representative_NID"
                                    value="{{ $contract->company_representative_NID }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer d-flex flex-column flex-sm-row justify-content-start gap-2">
    ...
    <!-- تعديل بيانات الطرف الثاني Modal -->
    <div class="modal fade" id="editRepresentativeTwoModal" tabindex="-1"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control border-primary"
                                    ...
                                    value="{{ $contract->customer_representative }}" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">الجنسية</label>
                                <input type="text" class="form-control border-primary"
                                    name="customer_representative_nationality"
                                    value="{{ $contract->customer_representative_nationality }}" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">الرقم القومي</label>
                                <input type="text" class="form-control border-primary"
                                    name="customer_representative_NID"
                                    value="{{ $contract->customer_representative_NID }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer d-flex flex-column flex-sm-row justify-content-start gap-2">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div
            ...
            <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                data-bs-target="#editServicesModal">
                تعديل الخدمات
            </button>
        </div>
        <div class="card-body">
                        ...
                        <div class="service-card border border-primary rounded p-3 h-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fw-bold text-dark">
                                        {{ $service->pivot->unit . ' ' . $service->pivot->unit_desc }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editServicesModal" tabindex="-1" aria-labelledby="editServicesModalLabel"
        aria-hidden="true">
                ...
                <form action="{{ route('contracts.update', $contract) }}" method="POST">
                    ...
                    <div class="modal-body text-dark">
                        <div id="services-container">
                            @foreach ($contract->services as $index => $service)
                                <div class="service-item border border-primary rounded p-3 mb-3"
                                    data-index="{{ $index }}">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-sm-4 col-md-2">
                                            ...
                                            <input type="number" step="1" min="1"
                                                ...
                                                value="{{ $service->pivot->unit }}">
                                        </div>
                                        <div class="col-12 col-sm-4 col-md-2">
                                            <label class="form-label">وصف الوحدة</label>
                                            <input type="text" class="form-control border-primary"
                                                name="services[{{ $index }}][unit_desc]"
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-12">
                    <form action="{{ route('contracts.add.attachment', $contract) }}" method="POST"
