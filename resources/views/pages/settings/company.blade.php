...
@section('content')
            ...
            <div class="mb-4 bg-light p-3 rounded">
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="branch" class="form-control border-primary"
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="CR" class="form-control border-primary"
                            value="{{ $company->CR }}">
                        @error('CR')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="TIN" class="form-control border-primary"
                            value="{{ $company->TIN }}">
                        @error('TIN')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="vatNumber" class="form-control border-primary"
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="national_address" class="form-control border-primary"
    ...
    <div class="card border-0 shadow-sm bg-white p-3 p-md-4 mb-4">
        ...
        <form action="{{ route($company->address ? 'companies.update.address' : 'companies.store.address', $company) }}"
            method="POST">
            @csrf
            ...
            <div class="mb-3 bg-light p-3 rounded">
                <div class="row g-3 mb-4">
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <input type="text" name="country" class="form-control border-primary"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <input type="text" name="secondary_number" class="form-control border-primary"
                            value="{{ $company->address->secondary_number ?? '' }}">
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <input type="text" name="short_address" class="form-control border-primary"
                            value="{{ $company->address->short_address ?? '' }}">
                    </div>
                </div>
                ...
                @foreach ($company->bankAccounts as $bankNumber)
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card border-0 rounded-4 shadow-sm overflow-hidden"
                            style="background: linear-gradient(135deg, var(--blue-5), var(--blue-1));">
                            <div class="card-body p-3">
                                <div
                                    class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-3">
                                    <div class="flex-grow-1 w-100">
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            <div>
                                                ...
                                                <span class="rounded-3 text-white fw-semibold d-block d-sm-inline"
                                            ...
                                            <div>
                                                ...
                                                <span class="rounded-3 text-white fw-semibold d-block d-sm-inline"
                                                    style="font-family: 'Courier New'; word-break: break-all;">
                                                    {{ $bankNumber->iban ?? 'N/A' }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-row flex-sm-column gap-2 align-self-stretch">
                                        <button type="button"
                                            class="btn btn-light btn-sm shadow-sm flex-grow-1 flex-sm-grow-0"
                                            data-bs-toggle="modal" data-bs-target="#editBankModal{{ $bankNumber->id }}"
                                            style="width: auto; min-width: 36px; height: 36px; border-radius: 8px; padding: 0;">
                                            <i class="fas fa-edit" style="font-size: 14px;"></i>
                                        </button>
                                        <button type="button"
                                            class="btn btn-light btn-sm shadow-sm flex-grow-1 flex-sm-grow-0"
                                            data-bs-toggle="modal" data-bs-target="#deleteBankModal{{ $bankNumber->id }}"
                                            style="width: auto; min-width: 36px; height: 36px; border-radius: 8px; padding: 0;">
                    ...
                    <!-- Delete Bank Modal -->
                    <div class="modal fade" id="deleteBankModal{{ $bankNumber->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="text-center">هل أنت متأكد من حذف حساب بنك
                                        <strong>{{ $bankNumber->bank }}</strong>؟</p>
                                </div>
                                <div class="modal-footer d-flex flex-column flex-sm-row justify-content-center gap-2">
                                    ...
                                    <form action="{{ route('companies.delete.bank', $bankNumber->id) }}" method="POST"
                    ...
                    <!-- update Bank Modal -->
                    <div class="modal fade" id="editBankModal{{ $bankNumber->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="bank" class="form-control border-primary"
                                                value="{{ $bankNumber->bank }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">رقم الحساب</label>
                                            <input type="text" name="account_number"
                                                class="form-control border-primary"
                                                value="{{ $bankNumber->account_number }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">IBAN</label>
                                            <input type="text" name="iban" class="form-control border-primary"
                                                value="{{ $bankNumber->iban }}">
                                        </div>
                                    </div>
                                    <div class="modal-footer d-flex flex-column flex-sm-row flex-row-reverse gap-2">
                                        <button type="submit" class="btn btn-primary fw-bold order-1 order-sm-1">تعديل
                                            الحساب</button>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('companies.store.bank', $company) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">رقم الحساب</label>
                                <input type="text" name="account_number" class="form-control border-primary"
                        ...
                        <div class="modal-footer d-flex flex-column flex-sm-row flex-row-reverse gap-2">
                            <button type="submit" class="btn btn-primary fw-bold order-1 order-sm-1">إضافة
                                الحساب</button>
                            <button type="button" class="btn btn-secondary fw-bold order-2 order-sm-2"
                                data-bs-dismiss="modal">إلغاء</button>
                        </div>
                ...
                @forelse($company->modules ?? [] as $module)
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card h-100 border-0 rounded-4 shadow-sm overflow-hidden"
                            style="{{ $module->pivot->is_active ? 'background: linear-gradient(135deg, var(--blue-5), var(--blue-1));' : 'background: linear-gradient(135deg, #adb5bd, #6c757d);' }}">
