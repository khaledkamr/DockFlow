...
@section('content')
                    ...
                    <div class="modal-body text-dark">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="type" id="type" class="form-select border-primary" required>
                                    <option value="" disabled selected>اختر نوع المورد</option>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('users.supplier.update', $supplier) }}" method="POST">
                                        ...
                                        <div class="modal-body text-dark">
                                            <div class="row g-3 mb-3">
                                                <div class="col-12 col-md-6">
                                                    <label for="name{{ $supplier->id }}" class="form-label">إسم
                                                        المورد</label>
                                                    <input type="text" class="form-control border-primary"
                                                        id="name{{ $supplier->id }}" name="name"
                                                        value="{{ $supplier->name }}">
                                                    @error('name')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label for="CR{{ $supplier->id }}" class="form-label">السجل
                                                        التجاري</label>
                                                    <input type="text" class="form-control border-primary"
                                                        id="CR{{ $supplier->id }}" name="CR"
                                                        value="{{ $supplier->CR }}">
                                                    @error('CR')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-12 col-md-6">
                                                    <label for="vatNumber{{ $supplier->id }}" class="form-label">الرقم
                                                        الضريبي</label>
                                                    <input type="text" class="form-control border-primary"
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label for="national_address{{ $supplier->id }}"
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-12 col-md-6">
                                                    <label for="phone{{ $supplier->id }}" class="form-label">رقم
                                                        الهاتف</label>
                                                    <input type="text" class="form-control border-primary"
                                                        id="phone{{ $supplier->id }}" name="phone"
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label for="email{{ $supplier->id }}" class="form-label">البريد
                                                        الإلكتروني</label>
                                                    <input type="text" class="form-control border-primary"
                                                        id="email{{ $supplier->id }}" name="email"
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select name="account_id" id="account_id{{ $supplier->id }}"
                                                        class="form-select border-primary account-select"
                                                        data-modal="#editSupplierModal{{ $supplier->id }}">
                                                        <option value="" disabled selected>اختر الحساب الأساسي
                                                        </option>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select name="settlement_account_id"
                                                        id="settlement_account_id{{ $supplier->id }}"
                                                        class="form-select border-primary settlement-account-select"
                                                        data-modal="#editSupplierModal{{ $supplier->id }}">
                                                        <option value="" disabled selected>اختر حساب التسوية</option>
                                                        @foreach ($accounts as $account)
                                                            <option value="{{ $account->id }}"
                                                                {{ $supplier->settlement_account_id == $account->id ? 'selected' : '' }}>
                                                                {{ $account->name }} ({{ $account->code }})
                                                            </option>
                                                        @endforeach
                                                    </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize Select2 for account selects inside modals
            $('.account-select, .settlement-account-select').each(function() {
                const $select = $(this);
                const modalId = $select.data('modal');

                $select.select2({
                    placeholder: $select.find('option[disabled][selected]').text(),
                    allowClear: true,
                    width: '100%',
                    dir: 'rtl',
