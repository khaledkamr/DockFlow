...
@section('title', 'تقارير معاملات التخليص')

@section('content')
    <h1 class="mb-4">تقارير معاملات التخليص</h1>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-6 col-md-6 col-lg">
                    ...
                    <select name="status" class="form-select border-primary">
                        ...
                        <option value="مغلقة" {{ request('status') == 'مغلقة' ? 'selected' : '' }}>
                            مغلقة
                        </option>
                        <option value="معلقة" {{ request('status') == 'معلقة' ? 'selected' : '' }}>
                            معلقة
                        </option>
                    </select>
                </div>
    ...
    <div class="card border-0 shadow-sm rounded-3 p-3">
        ...
        <div class="table-container" id="tableContainer">
            <table class="table table-striped">
                ...
                <tbody>
                    @if ($transactions->isEmpty() || !request()->hasAny(['customer', 'from', 'to', 'status', 'invoice_status']))
                        <tr>
