    ...
    <div class="row mb-4">
        <div class="col-12 col-lg-4 mb-3 mb-lg-0">
            <div class="card rounded-3 shadow-sm border-0">
                <div class="card-body">
                    <h5
                        class="card-title d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center text-dark fw-bold mb-4">
            ...
            <div class="card rounded-3 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="chart-container d-flex justify-content-center align-items-center"
                        style="position: relative; height:257px;">
