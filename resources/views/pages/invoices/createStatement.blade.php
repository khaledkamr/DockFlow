    ...
    <div class="row g-2">
        ...
        <div class="col-md-2">
            <button type="submit" class="btn btn-primary fw-bold" onclick="this.querySelector('i').className='fas fa-spinner fa-spin ms-1'">
                عرض الفواتير <i class="fa-solid fa-file-invoice ms-1"></i>
            </button>
        </div>
        <div class="col-md-4">
            <div class="input-group">
                <input id="search-input" class="form-control border-primary" type="search" 
                        placeholder="إبحث عن فاتورة بالكود..." 
                        aria-label="Search">
...
@if (isset($invoices) && $invoices->count() > 0)
    <form method="POST" action="{{ route('invoices.statements.store') }}" class="mb-5">
        ...
        <div class="alert alert-info mb-3" id="selection-counter" style="display: none;">
            ...
            تم تحديد <span id="selected-count">0</span> فاتورة من أصل <span id="visible-count">{{ $invoices->count() }}</span> فاتورة
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center fw-bold bg-dark text-white">كود الفاتورة</th>
                        <th class="text-center fw-bold bg-dark text-white">نوع الفاتورة</th>
                        <th class="text-center fw-bold bg-dark text-white">إسم العميل</th>
                        <th class="text-center fw-bold bg-dark text-white">تاريخ الفاتورة</th>
                        <th class="text-center fw-bold bg-dark text-white">المبلغ الإجمالي</th>
                    ...
                    @foreach ($invoices as $invoice)
                        <tr class="text-center invoice-row" 
                            ...
                            <td class="text-primary fw-bold">
                                <a href="{{ route('invoices.details', $invoice) }}" class="text-decoration-none invoice-code">
                                    {{ $invoice->code }}
                                </a>
                            </td>
                            <td>{{ $invoice->type }}</td>
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary fw-bold" id="create-statement-btn" disabled>
