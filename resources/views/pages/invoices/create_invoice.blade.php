...
@section('content')
    ...
    <h1 class="mb-4">إضافة فاتورة تخزين</h1>
    ...
    @if (isset($containers) && $containers->count() > 0)
        <form method="POST" action="{{ route('invoices.store') }}" class="mb-5">
            ...
            <div class="alert alert-info mb-3" id="selection-counter" style="display: none;">
                ...
                تم تحديد <span id="selected-count">0</span> حاوية من أصل <span
                    id="visible-count">{{ $containers->count() }}</span> حاوية
                <span class="ms-3">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center fw-bold bg-dark text-white text-nowrap">رقم الحاوية</th>
                            <th class="text-center fw-bold bg-dark text-white text-nowrap">إسم العميل</th>
                            <th class="text-center fw-bold bg-dark text-white text-nowrap">تاريخ التسليم</th>
                    ...
                    <tbody id="containers-table-body">
                        @foreach ($containers as $container)
                            <tr class="text-center container-row" data-container-id="{{ $container->id }}"
                                ...
                                <td class="checkbox-cell" style="cursor: pointer;">
                                    <div class="form-check d-flex justify-content-center">
                                        <input type="checkbox" name="container_ids[]" value="{{ $container->id }}"
                                            class="form-check-input container-checkbox" style="transform: scale(1.2);">
                                    </div>
                                </td>
                                ...
                                <td class="fw-bold text-success">{{ number_format($container->total, 2) }} <i
                                        data-lucide="saudi-riyal"></i></td>
                                <td><span class="badge bg-success">تم التسليم <i class="fa-solid fa-check"></i></span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
