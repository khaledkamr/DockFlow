...
@section('content')
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 mb-3">
        <h1 class="mb-0">
            <i class="fa-solid fa-truck-fast"></i> <span class="d-none d-md-inline">بوليصة الشحن</span><span
                class="d-sm-inline d-md-none">بوليصة</span>
            {{ $policy->code }}
        </h1>
        <div class="d-flex flex-row gap-2">
            ...
            @endif
            <a href="{{ route('export.shipping.policy', $policy->id) }}" target="_blank"
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select name="type" id="type" class="form-select border-primary">
                                    <option value="ناقل داخلي"
                                        {{ old('type', $policy->type) == 'ناقل داخلي' ? 'selected' : '' }}>ناقل داخلي
                                    </option>
                                    <option value="ناقل خارجي"
                                        {{ old('type', $policy->type) == 'ناقل خارجي' ? 'selected' : '' }}>ناقل خارجي
                                    </option>
                                </select>
                            </div>
                            <div class="col-12 col-md-4 internal-field">
                                ...
                                <div class="col-12 col-md-4 internal-field">
                                    ...
                                    <input type="text" class="form-control border-primary" name="plate_number"
                                        id="plate_number"
                                        value="{{ old('plate_number', $policy->vehicle ? $policy->vehicle->plate_number : '') }}"
                                        readonly>
                                    <input type="hidden" name="vehicle_id" id="vehicle_id"
                                        value="{{ old('vehicle_id', $policy->vehicle_id) }}">
                                </div>
                                ...
                                <div class="col-12 col-md-4 external-field" style="display: none">
                                    ...
                                    <input type="text" class="form-control border-primary" name="driver_name"
                                        id="driver_name" value="{{ old('driver_name', $policy->driver_name) }}">
                                    @error('driver_name')
                                        <div class="text-danger">إسم السائق مطلوب</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-4 external-field" style="display: none">
                                    ...
                                    <input type="text" class="form-control border-primary" name="vehicle_plate"
                                        id="vehicle_plate" value="{{ old('vehicle_plate', $policy->vehicle_plate) }}">
                                    @error('vehicle_plate')
                                ...
                                <div class="col-12 col-md-2 external-field">
                                    ...
                                    <select name="paid" id="paid" class="form-select border-primary"
                                        style="width: 100%;">
                                        <option value="0" {{ old('paid', $policy->paid) == 0 ? 'selected' : '' }}>لا
                                        </option>
                                        <option value="1" {{ old('paid', $policy->paid) == 1 ? 'selected' : '' }}>نعم
                                        </option>
                                    </select>
                                </div>
