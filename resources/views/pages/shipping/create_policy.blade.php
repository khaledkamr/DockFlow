            ...
            <div class="row mb-3">
                ...
                <div class="col internal-field">
                    ...
                    <div class="col external-field" style="display: none">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-select border-primary" style="width: 100%;">
                            ...
                            @foreach ($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" data-cr="{{ $supplier->CR }}"
                    ...
                    <div class="col external-field" style="display: none">
                        ...
                        <input type="text" class="form-control border-primary" name="supplier_phone" id="supplier_phone"
                            readonly>
                    </div>
                </div>
                            ...
                            <table class="table table-hover" id="goods-table">
                                ...
                                <tbody id="goods-tbody">
                                    <tr class="goods-row">
                                        ...
                                        <td>
                                            <input type="number" step="1" class="form-control" name="goods[0][quantity]" min="0">
                                        </td>
                                        <td>
                                            <input type="number" step="1" class="form-control" name="goods[0][weight]" min="0">
                                        </td>
                                        <td>
