    ...
    <div class="row g-3 mb-3 mb-md-4">
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    @if($container->notes)
                       <p class="mb-0">{{ $container->notes }}</p>
                    @else
                        <div class="text-center text-muted py-4">
                            <i class="fas fa-inbox fa-2x mb-2"></i>
                            <p class="mb-0">لا توجد ملاحظات على هذه الحاوية</p>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="d-flex flex-column gap-3 position-relative">
                    ...
                    <div class="timeline-state">
                        ...
                        <div class="position-relative" style="z-index: 3;">
                            <div class="timeline-icon d-flex align-items-center justify-content-center position-relative rounded-circle text-white fs-5 bg-primary" style="width: 48px; height: 48px;">
                    ...
                    @if($storagePolicy)
                        <div class="timeline-state">
                            ...
                            <div class="flex-grow-1 p-2 p-md-3 rounded-3 shadow-sm border-start border-4 border-primary">
                                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-2 mb-2">
                                    <h5 class="mb-0 fs-6">إتفاقية تخزين</h5>
                                    <small class="d-flex flex-wrap align-items-center text-secondary">
                                        <i class="far fa-calendar-alt me-1"></i>
                    ...
                    @if($receivePolicy)
                        <div class="timeline-state">
                            ...
                            <div class="flex-grow-1 p-2 p-md-3 rounded-3 shadow-sm border-start border-4 border-primary">
                                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-2 mb-2">
                                    <h5 class="mb-0 fs-6">إتفاقية تسليم</h5>
                                    <small class="d-flex flex-wrap align-items-center text-secondary">
                                        <i class="far fa-calendar-alt me-1"></i>
