...
@section('content')
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal"
                data-bs-target="#editTransportOrderModal">
                <i class="fas fa-edit me-1"></i>
                تعديل
            </button>
            @if (auth()->user()->roles->pluck('name')->contains('Admin'))
                <button class="btn btn-outline-danger" type="button" data-bs-toggle="modal"
                    data-bs-target="#deleteTransportOrderModal">
    ...
    <div class="modal fade" id="deleteTransportOrderModal" tabindex="-1" aria-labelledby="deleteTransportOrderModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="editTransportOrderModal" tabindex="-1" aria-labelledby="editTransportOrderModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white fw-bold" id="editTransportOrderModalLabel">تعديل بيانات اشعار النقل
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select name="type" id="type" class="form-select border-primary">
                                    <option value="ناقل داخلي"
                                        {{ old('type', $transportOrder->type) == 'ناقل داخلي' ? 'selected' : '' }}>ناقل
                                        داخلي</option>
                                    <option value="ناقل خارجي"
                                        {{ old('type', $transportOrder->type) == 'ناقل خارجي' ? 'selected' : '' }}>ناقل
                                        خارجي</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-4 internal-field">
                                ...
                                <div class="col-12 col-md-4 internal-field">
                                    ...
                                    <input type="text" class="form-control border-primary" name="driver_NID"
                                        id="driver_NID"
                                        value="{{ old('driver_NID', $transportOrder->driver ? $transportOrder->driver->NID : '') }}"
                                        readonly>
                                </div>
                                <div class="col-12 col-md-4 internal-field">
                                    ...
                                    <input type="text" class="form-control border-primary" name="plate_number"
                                        id="plate_number"
                                        value="{{ old('plate_number', $transportOrder->vehicle ? $transportOrder->vehicle->plate_number : '') }}"
                                        readonly>
                                    <input type="hidden" name="vehicle_id" id="vehicle_id"
                                        value="{{ old('vehicle_id', $transportOrder->vehicle_id) }}">
                                </div>
                                <div class="col-12 col-md-4 external-field" style="display: none">
                                    <label class="form-label d-block">إســم المورد</label>
                                    <select name="supplier_id" id="supplier_id" class="form-select border-primary"
                                        style="width: 100%;">
                                ...
                                <div class="col-12 col-md-4 external-field" style="display: none">
                                    ...
                                    <input type="text" class="form-control border-primary" name="driver_name"
                                        id="driver_name" value="{{ old('driver_name', $transportOrder->driver_name) }}">
                                    @error('driver_name')
                                ...
                                <div class="col-12 col-md-4 external-field" style="display: none">
                                    <label class="form-label">لوحة السيارة</label>
                                    <input type="text" class="form-control border-primary" name="vehicle_plate"
                                        id="vehicle_plate"
                                ...
                                <div class="col-12 col-md-2 external-field">
                                    ...
                                    <input type="number" class="form-control border-primary" name="supplier_cost"
                                        id="supplier_cost" min="0" step="any"
                                ...
                                <div class="col-12 col-md-2 external-field">
                                    ...
                                    <select name="paid" id="paid" class="form-select border-primary"
                                        style="width: 100%;">
                                        <option value="0"
                                            {{ old('paid', $transportOrder->paid) == 0 ? 'selected' : '' }}>لا</option>
                                        <option value="1"
                                            {{ old('paid', $transportOrder->paid) == 1 ? 'selected' : '' }}>نعم</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md internal-field">
                                    <label class="form-label">مصاريف الديزل</label>
                                    <input type="number" class="form-control border-primary" name="diesel_cost"
                                        id="diesel_cost" min="0" step="any"
                                ...
                                <div class="col-12 col-md internal-field">
                                    ...
                                    <input type="number" class="form-control border-primary" name="driver_wage"
                                        id="driver_wage" min="0" step="any"
                                ...
                                <div class="col-12 col-md">
                                    ...
                                    <input type="number" class="form-control border-primary" name="commission"
                                        id="commission" min="0" step="any"
                                        value="{{ old('commission', $transportOrder->commission) }}">
                                    @error('commission')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md">
                                    ...
                                    <input type="number" class="form-control border-primary" name="clearance_fee"
                                        id="clearance_fee" min="0" step="any"
                                        value="{{ old('clearance_fee', $transportOrder->clearance_fee) }}">
                                    @error('clearance_fee')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md">
                                    ...
                                    <input type="number" class="form-control border-primary" name="late_fee"
                                        id="late_fee" min="0" step="any"
                                        value="{{ old('late_fee', $transportOrder->late_fee) }}">
                                    @error('late_fee')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md">
                                    ...
                                    <input type="number" class="form-control border-primary" id="client_cost"
                                        name="client_cost" min="0" step="any"
                    ...
                    <div class="card-body">
                        <div class="row g-2 mb-3">
                            ...
                            <div class="col-6 col-sm-6">
                                ...
                                <p class="fw-bold mb-0">
                                    <a href="{{ route('users.customer.profile', $transportOrder->customer) }}"
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6 col-sm-6">
                                ...
                                @endif
                                <form method="POST" action="{{ route('transportOrders.toggle', $transportOrder) }}"
                                    class="d-inline mt-2">
                                    @csrf
                                    @method('PATCH')
                            ...
                            <div class="col-6 col-sm-6">
                                ...
                                <p class="fw-bold mb-0">
                                    ...
                                    @if ($transportOrder->supplier)
                                        <span
                                            class="badge bg-{{ $transportOrder->paid ? 'success' : 'danger' }}">{{ $transportOrder->paid ? 'مدفوع' : 'غير مدفوع' }}</span>
                                    @endif
                                </p>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
                        ...
                        <p class="fw-bold mb-0">{{ number_format($transportOrder->commission, 2) }} <i
                                data-lucide="saudi-riyal"></i></p>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
                        <label class="text-muted small">رسوم فسح</label>
                        <p class="fw-bold mb-0">{{ number_format($transportOrder->clearance_fee, 2) }} <i
                                data-lucide="saudi-riyal"></i></p>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
                        <label class="text-muted small">غرامة تأخير</label>
                        <p class="fw-bold mb-0">{{ number_format($transportOrder->late_fee, 2) }} <i
                                data-lucide="saudi-riyal"></i></p>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
